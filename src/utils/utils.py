...
class Utilities:
    ...
    def validate_password(self, password_entry, confirmation_entry, password_text, confirmation_text, event=None):
        ...
        is_valid_confirmation = self.validate_password_match(password_entry, confirmation_entry)


        self.format_password_label(password_text,["Senha válida", "Senha inválida"], is_valid_password)
        self.format_password_label(confirmation_text,["Senhas Iguais", "Senhas Diferentes"], is_valid_confirmation)
    ...
    def validate_username(self, login_entry, login_text, event=None):
        ...
        self.format_username_label(login_text,["Usuario valido", "Usuario inválido"], is_valid_username)
