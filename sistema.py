...
def conecta_bd(database, host, port, user, password):
...
class ValidarAcesso():
    def __init__(self):
        ...
        self.senha_logado = None
        self.acesso_usuario = None
        self.ModulosDoUsuario = None
        self.BtAgenda = None
        self.BtUsuario = None
        self.BtConfiguracoes = None
        self.BtEstoque = None
        self.BtCadastros = None
        self.Btcarteira = None
        self.BtFinancas = None
        self.BTEntrada = None
        self.BTSaida = None
        self.BTInventario = None
        self.BTCadastrarItens = None
        self.BTCadastrarClientes = None
        self.BTCriarNovoUsuario = None
        self.BTGerenciarUsuario = None
        self.BTRegistrarVenda = None
        self.BTFaturamento = None
        self.BTRegistrarDespesas = None
        self.BTOutrasRendas = None
        self.BtAgenda = None
        self.BtUsuario = None
        self.BtConfiguracoes = None
        self.BtEstoque = None
        ...
        self.BTOutrasRendas = None
        self.BtAgenda = None
        self.SenhaDigitado = None
        self.LoginDigitado = None
    ...
    def validar(self):
        ...
        if len(self.usuario_logado) == 0 or len(self.senha_logado) == 0:
            ...
            cursor = ConexaoPrincipal.cursor()
            cursor.execute(
...
class TrocarIMG():
    ...
    def insert_image(self, image_base64, usuario):  # Função para inserir ou atualizar a img no BD
        ...
        ConexaoPrincipal.commit()


class CadastroConf(): 

    def __init__(self):
        self.EntryUsuario = None
        self.EntrySenha = None
        self.MenuAcesso = None
        self.MenuStatus = None
        self.Bt_SalvarModulos = None
        self.BT_ModuloEstoque = None
        self.BT_ModuloCadastro = None
        self.BT_ModuloAgenda = None
        self.BT_ModuloCarteira = None
        self.BT_ModuloFinancas = None
        self.BT_ModuloUsuarios = None
        self.BT_ModuloConfiguracoes = None
        ...
        self.FrameModuloEstoqueResp = None
        self.Entrada_visualizar = None
        self.Entrada_novo = None
        self.Entrada_editar = None
        self.Entrada_remover = None
        self.saida_visualizar = None
        self.saida_novo = None
        self.saida_editar = None
        self.saida_remover = None
        self.inventario_visualizar = None
        self.inventario_novo = None
        self.inventario_editar = None
        self.inventario_remover = None
        self.FrameModuloCadastroResp = None
        self.item_visualizar = None
        self.item_novo = None
        self.item_editar = None
        self.item_remover = None
        self.cliente_visualizar = None
        self.cliente_novo = None
        self.cliente_editar = None
        self.cliente_remover = None
        self.criarusuario_visualizar = None
        self.criarusuario_novo = None
        self.criarusuario_editar = None
        self.criarusuario_remover = None
        self.gerenciar_visualizar = None
        self.gerenciar_novo = None
        self.gerenciar_editar = None
        self.gerenciar_remover = None
        self.FrameModuloAgendaResp = None
        self.agenda_visualizar = None
        self.agenda_novo = None
        self.agenda_editar = None
        self.agenda_remover = None
        self.FrameModuloCarteiraResp = None
        self.vendas_visualizar = None
        self.vendas_novo = None
        self.vendas_editar = None
        self.vendas_remover = None
        self.faturamento_visualizar = None
        self.faturamento_novo = None
        self.faturamento_editar = None
        self.faturamento_remover = None
        self.FrameModuloFinancasResp = None
        self.despesas_visualizar = None
        self.despesas_novo = None
        self.despesas_editar = None
        self.despesas_remover = None
        self.rendas_visualizar = None
        self.rendas_novo = None
        self.rendas_editar = None
        self.rendas_remover = None
        self.FrameModuloUsuarioResp = None
        self.usuario_visualizar = None
        self.usuario_novo = None
        self.usuario_editar = None
        self.usuario_remover = None
        self.FrameModuloConfiguracoesResp = None
        self.configuracoes_visualizar = None
        self.configuracoes_novo = None
        self.configuracoes_editar = None
        self.configuracoes_remover = None

        self.FrameNovoUserResposta = None
        self.acesso_usuario = None
    ...
    def novo_user(self, frame_resp):
        ...
        Painel_NovoUsuario = ctk.CTkButton(frame_resp, text="", width=1100, height=90, border_width=3,
        ...
        self.BT_ModuloEstoque = ctk.CTkButton(PainelBotoes, image=EstoqueIcon, text="Estoque",
                                              ...
                                              anchor="w", command=lambda: self.Modulo_Estoque(frame_resp=frame_resp))
        ...
        self.BT_ModuloCadastro = ctk.CTkButton(PainelBotoes, image=CadastroIcon, text="Cadastro",
                                               text_color=("black", "white"), fg_color="transparent",
                                               hover_color=("#FFD6D6", "gray17"), corner_radius=0, height=40, width=100,
                                               anchor="w", command=lambda: self.Modulo_Cadastro(frame_resp=frame_resp))
        ...
        self.BT_ModuloAgenda = ctk.CTkButton(PainelBotoes, image=AgendaIcon, text="Agenda",
                                             text_color=("black", "white"), fg_color="transparent",
                                             hover_color=("#FFD6D6", "gray17"), corner_radius=0, height=40, width=100,
                                             anchor="w", command=lambda: self.Modulo_Agenda(frame_resp=frame_resp))
        ...
        self.BT_ModuloCarteira = ctk.CTkButton(PainelBotoes, image=carteiraIcon, text="Carteira",
                                               text_color=("black", "white"), fg_color="transparent",
                                               hover_color=("#FFD6D6", "gray17"), corner_radius=0, height=40, width=100,
                                               anchor="w", command=lambda: self.Modulo_Carteira(frame_resp=frame_resp))
        ...
        self.BT_ModuloFinancas = ctk.CTkButton(PainelBotoes, image=FinancasIcon, text="Finanças",
                                               text_color=("black", "white"), fg_color="transparent",
                                               hover_color=("#FFD6D6", "gray17"), corner_radius=0, height=40, width=100,
                                               anchor="w", command=lambda: self.Modulo_Financas(frame_resp=frame_resp))
        ...
        self.BT_ModuloUsuarios = ctk.CTkButton(PainelBotoes, image=UsuarioIcon, text="Usuarios",
                                               text_color=("black", "white"), fg_color="transparent",
                                               hover_color=("#FFD6D6", "gray17"), corner_radius=0, height=40, width=100,
                                               anchor="w", command=lambda: self.Modulo_Usuario(frame_resp=frame_resp))
        ...
        self.BT_ModuloConfiguracoes = ctk.CTkButton(PainelBotoes, image=ConfiguracoesIcon, text="Configurações",
                                                    ...
                                                    width=100, anchor="w",
                                                    command=lambda: self.Modulo_Configuracoes(frame_resp=frame_resp))
    ...
    def Modulo_Estoque(self, frame_resp):
        ...
        if self.FrameModuloEstoqueResp is None:
            ...
            self.destacar(nunlista=1, botão=self.BT_ModuloEstoque)
    ...
    def Modulo_Cadastro(self, frame_resp):
        ...
        if self.FrameModuloCadastroResp is None:
            ...
            self.destacar(1, self.BT_ModuloCadastro)
    ...
    def Modulo_Agenda(self, frame_resp):
        ...
        if self.FrameModuloAgendaResp is None:
            ...
            self.destacar(1, self.BT_ModuloAgenda)
    ...
    def Modulo_Carteira(self, frame_resp):
        ...
        if self.FrameModuloCarteiraResp is None:
            ...
            self.destacar(1, self.BT_ModuloCarteira)
    ...
    def Modulo_Financas(self, frame_resp):
        ...
        if self.FrameModuloFinancasResp is None:
            ...
            self.destacar(1, self.BT_ModuloFinancas)
    ...
    def Modulo_Usuario(self, frame_resp):
        ...
        if self.FrameModuloUsuarioResp is None:
            ...
            self.destacar(1, self.BT_ModuloUsuarios)
    ...
    def Modulo_Configuracoes(self, frame_resp):
        ...
        if self.FrameModuloConfiguracoesResp is None:
            ...
            self.destacar(1, self.BT_ModuloConfiguracoes)
    ...
    def gerenciar_user(self, frame_resp):
        if self.acesso_usuario == "ADM":
            ...
            def modulos_usuario(indice, usuario_entry, status_menu, acesso_menu):
                ...
                cursor.execute(f"select * from modulos where id = '{usuarios[indice]}'")
                ...
                Bt_Salvar_modulo = ctk.CTkButton(frame_resp, text="Salvar",  image=SalvarIcon, text_color=("black","white"), 
                ...
                Bt_Cancelar_modulo = ctk.CTkButton(frame_resp, text="Voltar",  image=
            ...
            def editar_usuario(i):
                ...
                salvar_button[i] = ctk.CTkButton(scrol, text="Salvar", text_color=("black","white"), image=SalvarIcon, width=60,  fg_color=("transparent"), hover_color=("white", '#191919'), command=lambda: salvar_usuario(i, usuario_entry, status_menu, acesso_menu))
                salvar_button[i].grid(row=i, column=4)
                
                cancelar_button[i] =ctk.CTkButton(scrol, text="Cancelar", text_color=("black","white"), image=VoltarIcon, width=60,  fg_color=("transparent"), hover_color=("white", '#191919'), command=lambda: cancelar_usuario(i, usuario_entry, status_menu, acesso_menu))
                cancelar_button[i].grid(padx=5, row=i, column=5)

                Editar_Modulos[i] =ctk.CTkButton(scrol, text="Modulos", text_color=("black","white"),image=EditarIcon, width=60,  fg_color=("transparent"), hover_color=("white", '#191919'), command=lambda: modulos_usuario(i, usuario_entry, status_menu, acesso_menu))
                Editar_Modulos[i].grid(padx=5, row=i, column=6)

                excluir_button[i] =ctk.CTkButton(scrol, text="Deletar", text_color=("black","white"),image=DeletarIcon, width=60, fg_color=("transparent"), hover_color=("white", '#191919'), command=lambda: excluir_usuario(i, usuario_entry, status_menu, acesso_menu))
            ...
            # adicionado nas lista os botoes com cada usuario cadastrado no banco de dados
                for i in range(len(usuarios)):
                    ...
                    editar_button.append(ctk.CTkButton(scrol, text="Editar", text_color=("black","white"), image=EditarIcon, width=60, fg_color=("transparent"), hover_color=("white", '#191919'), command=lambda i=i: editar_usuario(i)))
            ...
            self.Pesquisar = ctk.CTkEntry(frame_resp, placeholder_text="Digite o nome do usuario aqui:", width=550, height=40)
            self.Pesquisar.place(relx=0.2, rely=0.18, anchor="w")



            self.Bt_Todos = ctk.CTkButton(frame_resp, text="TODOS", image=EntradaIcon, text_color=("black","white"), 
                                        width=80,fg_color=("white", "gray10"), hover_color=("gray80", 'gray40'), command=Reexibir)
            self.Bt_Todos.place(relx=0.7, rely=0.18, anchor="w")



            self.Bt_Pesquisar = ctk.CTkButton(frame_resp, image=VisualizarIcon, text_color=("black","white"), text="PESQUISAR",
...
class UsuarioConf(TrocarIMG):
    ...
    def usuario_funcs(self, frame_resp, labelIMG):
        ...
        Painel_FtPerfil = ctk.CTkButton(frame_resp, text="", width=1100, height=90, border_width=1,
                                        fg_color="transparent", hover_color=("#FBECEC", "gray14"))
        ...
        bt = ctk.CTkButton(Painel_FtPerfil, image=ImagemIcon, text="Alterar", command=Trocar_img,
        ...
        def Editar_Usuario():
            ...
            if usuarioDigitado != None:
                ...
                if len(usuarioDigitado) >= 3:
                    ...
                    if not respostaBD:
                        cursor.execute(f"UPDATE Usuarios SET usuario = '{usuarioDigitado}' WHERE usuario = '{self.usuario_logado}'")
                        self.usuario_logado = str(usuarioDigitado)
                        ConexaoPrincipal.commit()
                        LabelUsuario.configure(text=usuarioDigitado)

                    elif usuarioDigitado == self.usuario_logado:
        ...
        Painel_Usuario = ctk.CTkButton(frame_resp, text="", width=1100, height=90, border_width=1,
                                       fg_color="transparent", hover_color=("#FBECEC", "gray14"))
        ...
        LabelAcesso = ctk.CTkLabel(Painel_Usuario, text=f"{self.acesso_usuario.upper()}", font=corpo,
        ...
        def Trocar_senha():
            ...
            def salvar():
                ...
                cursor =  ConexaoPrincipal.cursor()
                cursor.execute(
                    f"SELECT senha FROM Usuarios WHERE usuario = '{self.usuario_logado}' AND senha = '{atual}'")
        ...
        Painel_Senha = ctk.CTkButton(frame_resp, text="", width=1100, height=90, border_width=1, fg_color="transparent",
        ...
        Painel_Excluir = ctk.CTkButton(frame_resp, text="", width=1100, height=90, border_width=1,
                                       fg_color="transparent", hover_color=("#FBECEC", "gray14"))
...
class DestacarButton():
  
    def destacar(self, nunlista = int, botão = object, fg2 = "transparent"):

        lista = ([self.BtHome, self.BtEstoque,  self.BtCadastros, self.BtAgenda, self.Btcarteira, self.BtFinancas, self.BtUsuario, self.BtConfiguracoes],
                 [self.BT_ModuloEstoque, self.BT_ModuloCadastro, self.BT_ModuloAgenda, self.BT_ModuloCarteira, self.BT_ModuloFinancas, self.BT_ModuloUsuarios, 
                  self.BT_ModuloConfiguracoes])
    
        for valor in lista[nunlista]:
            if valor == botão:      
                if nunlista == 0:
                    botão.configure(fg_color=("white", "#880016"))
                else:
                    botão.configure(fg_color=("#FFD6D6", "gray17"))
            else:
                valor.configure(fg_color=fg2)


class Menu(UsuarioConf, ValidarAcesso, CadastroConf, DestacarButton):
    def __init__(self):

        # tela de login
        super().__init__()
        self.screen_height = None
        self.screen_wedth = None
        ...
        self.BtEntrar = ctk.CTkButton(self.Root_login, text="Entrar", command=self.validar,
        ...
        appearance_mode_optionemenu = ctk.CTkOptionMenu(self.Root_login, font=self.FontBody, width=100, height=20,
                                                        values=["Dark", "light"], command=self.aparencia)
    ...
    def frame_Inicial(self):
        ...
        self.frame_OcultarMenu = ctk.CTkFrame(self.rootHome, fg_color="transparent", width=37,
                                              height=self.screen_height, corner_radius=0)
        self.frame_OcultarMenu.grid(row=0, column=1)

        self.frame_temp = ctk.CTkFrame(self.rootHome, fg_color="transparent", width=self.screen_wedth,
                                       height=self.screen_height, corner_radius=0)
        self.frame_temp.grid(row=0, column=2)

        self.BtOcultar = ctk.CTkButton(self.frame_OcultarMenu, text="", image=MenuIcon, anchor="w", width=23, height=23,
                                       fg_color="transparent", text_color=("black", "white"),
                                       command=self.ocultarJanela)
        ...
        self.Btfoto_perfil = ctk.CTkButton(self.frame_MenuLateralEsq, text="", image=perfilIcon,
                                         command=self.Frame_Usuario, fg_color="transparent")
        ...
        appearance_mode_optionemenu = ctk.CTkOptionMenu(self.frame_MenuLateralEsq, font=self.FontBody, width=150,
                                                        height=30, values=["Dark", "light"], command=self.aparencia)
        ...
        self.iniciar_img_perfil(self.Btfoto_perfil)
        self.Frame_Home()
    ...
    def Frame_Home(self):
        ...
        self.frame_OcultarMenu = ctk.CTkFrame(self.rootHome, width=37, height=self.screen_height, corner_radius=0,
                                              fg_color=("white", "#880016"))
        self.frame_OcultarMenu.grid(row=0, column=1)
        self.FrameLateralAtual = self.frame_OcultarMenu

        self.FrameHomegResposta = ctk.CTkFrame(self.rootHome, fg_color="transparent", width=self.screen_wedth,
                                               height=self.screen_height, corner_radius=0)
        self.FrameHomegResposta.grid(row=0, column=2)
        self.frameRespostaAtual = self.FrameHomegResposta

        self.destacar(nunlista=0,botão=self.BtHome)
    ...
    def Frame_Estoque(self):
        ...
        self.destacar(nunlista=0,botão=self.BtEstoque)

        self.FrameLateralAtual.destroy()
        self.frameRespostaAtual.destroy()

        self.FrameEstoqueLateral = ctk.CTkFrame(self.rootHome, width=176, height=self.screen_height,
                                                fg_color=("white", "#880016"), corner_radius=0)
        self.FrameEstoqueLateral.grid(row=0, column=1)
        self.FrameLateralAtual = self.FrameEstoqueLateral

        self.BtOcultar = ctk.CTkButton(self.FrameLateralAtual, text="", image=MenuIcon, anchor="w", width=23, height=23,
                                       fg_color="transparent", command=self.ocultarJanela)
        self.BtOcultar.place(x=138, y=1)

        self.BTEntrada = ctk.CTkButton(self.FrameLateralAtual, text="Entrada", image=EntradaIcon, anchor="w", width=155,
                                       fg_color=("#FFD6D6", "gray17"), text_color=("black", "white"),
                                       hover_color=("#ff9ea2", "black"))
        self.BTEntrada.place(x=10, y=120)

        self.BTSaida = ctk.CTkButton(self.FrameLateralAtual, text="Saida", image=SaidaIcon, anchor="w", width=155,
                                     fg_color=("#FFD6D6", "gray17"), text_color=("black", "white"),
                                     hover_color=("#ff9ea2", "black"))
        self.BTSaida.place(x=10, y=160)

        self.BTInventario = ctk.CTkButton(self.FrameLateralAtual, text="Inventario", image=InventarioIcon, anchor="w",
    ...
    def Frame_Cadastro(self):
        ...
        self.destacar(nunlista=0,botão=self.BtCadastros)


        self.FrameLateralAtual.destroy()
        self.frameRespostaAtual.destroy()

        self.FrameCadastroLateral = ctk.CTkFrame(self.rootHome, width=176, height=self.screen_height,
                                                 fg_color=("white", "#880016"), corner_radius=0)
        ...
        self.BTCadastrarItens = ctk.CTkButton(self.FrameLateralAtual, text="Cadastrar Itens", image=EstoqueIcon,
                                              anchor="w", width=155, fg_color=("#FFD6D6", "gray17"),
                                              text_color=("black", "white"),
                                              hover_color=("#ff9ea2", "black"))
        self.BTCadastrarItens.place(x=10, y=160)

        self.BTCadastrarClientes = ctk.CTkButton(self.FrameLateralAtual, text="Cadastrar Clientes", image=CadastroIcon,
                                                 anchor="w", width=155, fg_color=("#FFD6D6", "gray17"),
                                                 text_color=("black", "white"),
                                                 hover_color=("#ff9ea2", "black"),
        ...
        self.BTCriarNovoUsuario = ctk.CTkButton(self.FrameLateralAtual, text="Novo Usuario", image=UsuarioIcon,
                                                anchor="w", width=155, fg_color=("#FFD6D6", "gray17"),
                                                text_color=("black", "white"),
                                                hover_color=("#ff9ea2", "black"), command=lambda: self.Frame_NovoUser())
        self.BTCriarNovoUsuario.place(x=10, y=240)

        self.BTGerenciarUsuario = ctk.CTkButton(self.FrameLateralAtual, text="Gerenciar Usuarios",
                                                image=GerenciarUserIcon, anchor="w", width=155,
                                                fg_color=("#FFD6D6", "gray17"), text_color=("black", "white"),
                                                hover_color=("#ff9ea2", "black"),
                                                command=lambda: self.Frame_GerenciarUser())
    ...
    def Frame_NovoCLiente(self):
        ...
        self.FrameNovoCLienteLateral = ctk.CTkFrame(self.rootHome, width=37, height=self.screen_height,
                                                    fg_color=("white", "#880016"), corner_radius=0)
        self.FrameNovoCLienteLateral.grid(row=0, column=1)
        self.FrameLateralAtual = self.FrameNovoCLienteLateral

        self.FrameNovoClienteResposta = ctk.CTkFrame(self.rootHome, fg_color="transparent", width=self.screen_wedth,
                                                     height=self.screen_height, corner_radius=0)
    ...
    def Frame_NovoUser(self):
        ...
        self.FrameNBovoUserLateral = ctk.CTkFrame(self.rootHome, width=37, height=self.screen_height,
                                                  fg_color=("white", "#880016"), corner_radius=0)
        self.FrameNBovoUserLateral.grid(row=0, column=1)
        self.FrameLateralAtual = self.FrameNBovoUserLateral

        self.FrameNovoUserResposta = ctk.CTkFrame(self.rootHome, fg_color="transparent", width=self.screen_wedth,
                                                  height=self.screen_height, corner_radius=0)
    ...
    def Frame_GerenciarUser(self):
        ...
        self.FrameGerenciarUserLateral = ctk.CTkFrame(self.rootHome, width=37, height=self.screen_height,
                                                      fg_color=("white", "#880016"), corner_radius=0)
        self.FrameGerenciarUserLateral.grid(row=0, column=1)
        self.FrameLateralAtual = self.FrameGerenciarUserLateral

        self.FrameGerenciarUserResposta = ctk.CTkFrame(self.rootHome, fg_color="transparent", width=self.screen_wedth,
                                                       height=self.screen_height, corner_radius=0)
    ...
    def Frame_Agenda(self):
        ...
        self.destacar(nunlista=0,botão=self.BtAgenda)


        self.FrameLateralAtual.destroy()
        self.frameRespostaAtual.destroy()

        self.FrameAgendaLateral = ctk.CTkFrame(self.rootHome, width=37, height=self.screen_height,
                                               fg_color=("white", "#880016"), corner_radius=0)
        self.FrameAgendaLateral.grid(row=0, column=1)
        self.FrameLateralAtual = self.FrameAgendaLateral

        self.FrameAgendaResposta = ctk.CTkFrame(self.rootHome, fg_color="transparent", width=self.screen_wedth,
                                                height=self.screen_height, corner_radius=0)
    ...
    def Frame_carteira(self):
        self.destacar(nunlista=0,botão=self.Btcarteira)
        
        self.FrameLateralAtual.destroy()
        self.frameRespostaAtual.destroy()

        self.FramecarteiraLateral = ctk.CTkFrame(self.rootHome, width=176, height=self.screen_height,
                                                 fg_color=("white", "#880016"), corner_radius=0)
        ...
        self.BTRegistrarVenda = ctk.CTkButton(self.FrameLateralAtual, text="Registrar Venda", image=VendasIcon,
                                              anchor="w", width=155, fg_color=("#FFD6D6", "gray17"),
                                              text_color=("black", "white"),
                                              hover_color=("#ff9ea2", "black"))
        self.BTRegistrarVenda.place(x=10, y=280)

        self.BTFaturamento = ctk.CTkButton(self.FrameLateralAtual, text="Faturamento", image=FaturamentoIcon,
                                           anchor="w", width=155, fg_color=("#FFD6D6", "gray17"),
                                           text_color=("black", "white"),
                                           hover_color=("#ff9ea2", "black"))
    ...
    def Frame_financas(self):
        ...
        self.destacar(nunlista=0,botão=self.BtFinancas)
        

        self.FrameLateralAtual.destroy()
        self.frameRespostaAtual.destroy()

        self.FramefinancasLateral = ctk.CTkFrame(self.rootHome, width=176, height=self.screen_height,
                                                 fg_color=("white", "#880016"), corner_radius=0)
        ...
        self.BTRegistrarDespesas = ctk.CTkButton(self.FrameLateralAtual, text="Registrar Despesas", image=DespesaIcon,
                                                 anchor="w", width=155, fg_color=("#FFD6D6", "gray17"),
                                                 text_color=("black", "white"),
                                                 hover_color=("#ff9ea2", "black"))
        self.BTRegistrarDespesas.place(x=10, y=320)

        self.BTOutrasRendas = ctk.CTkButton(self.FrameLateralAtual, text="Outras Rendas +", image=ReceitaIcon,
                                            anchor="w", width=155, fg_color=("#FFD6D6", "gray17"),
                                            text_color=("black", "white"),
                                            hover_color=("#ff9ea2", "black"))
    ...
    def Frame_Usuario(self):
        ...
        self.destacar(nunlista=0,botão=self.BtUsuario)

        self.FrameLateralAtual.destroy()
        self.frameRespostaAtual.destroy()

        self.FrameUsuarioLateral = ctk.CTkFrame(self.rootHome, width=37, height=self.screen_height,
                                                fg_color=("white", "#880016"), corner_radius=0)
        self.FrameUsuarioLateral.grid(row=0, column=1)
        self.FrameLateralAtual = self.FrameUsuarioLateral

        self.FrameUsuarioresposta = ctk.CTkFrame(self.rootHome, fg_color="transparent", width=self.screen_wedth,
                                                 height=self.screen_height, corner_radius=0)
        ...
        self.usuario_funcs(self.FrameUsuarioresposta, self.Btfoto_perfil)

    def Frame_Configuracoes(self):

        self.destacar(nunlista=0,botão=self.BtConfiguracoes)

        self.FrameLateralAtual.destroy()
        self.frameRespostaAtual.destroy()

        self.FrameConfigLateral = ctk.CTkFrame(self.rootHome, width=37, height=self.screen_height,
                                               fg_color=("white", "#880016"), corner_radius=0)
        self.FrameConfigLateral.grid(row=0, column=1)
        self.FrameLateralAtual = self.FrameConfigLateral

        self.FrameConfigResposta = ctk.CTkFrame(self.rootHome, fg_color="transparent", width=self.screen_wedth,
                                                height=self.screen_height, corner_radius=0)
...
ConexaoPrincipal = conecta_bd(database='railway', host='containers-us-west-1.railway.app', port=5474, user='root',password="JThLpvacyDNwzFLPyLhX")
Menu()
